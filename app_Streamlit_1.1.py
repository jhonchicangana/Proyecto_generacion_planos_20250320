...
st.markdown(
    """
    <h2 style="text-align: center; font-size: 36px; font-weight: bold; color: white;">
...
valor_ingresado = int(st.number_input("Ingrese valor total de autorización", min_value=0.0, format="%.0f"))
st.session_state.fecha_pago_param = st.text_input("Ingrese la Fecha de Pago (DD/MM/YYYY)", value= st.session_state.fecha_pago_param)
st.session_state.fecha_aut_param  = st.text_input("Ingrese la Fecha de Autorización (DD/MM/YYYY)", value= st.session_state.fecha_aut_param)
st.session_state.top_codi_param  = st.text_input("Ingrese Tipos De Operacion",value= st.session_state.top_codi_param)
